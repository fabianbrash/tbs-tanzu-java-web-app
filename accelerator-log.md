...
```json
{
  "projectName" : "tbs-tanzu-java-web-app",
  "repositoryPrefix" : "harbor.fbclouddemo.us"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->tbs-tanzu-java-web-a...(truncated)]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].merge.transformations[0].sources[1].<combo>.transformations[1].transformations[1] (ReplaceText)
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [your-registry.io/project->harbor.fbclouddemo.u...(truncated)]
